		...
		<div class="page-wrapper">
			...
			<div class="page-breadcrumb">
				<div class="row align-items-center">
					<div class="col-5">
						<h4 class="page-title">Manajemen Ubah Tingkatan kerusakan</h4>
						<div class="d-flex align-items-center">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item" aria-current="page"><a href="kerusakan.php">Tingkatan kerusakan</a></li>
								<li class="breadcrumb-item active" aria-current="page">Ubah Tingkatan kerusakan</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-8 col-xlg-9 col-md-7">
						<div class="card">
							<div class="card-body">
								<form method="post" class="form-horizontal form-material" action="../ProsesA/e_kerusakan.php">
